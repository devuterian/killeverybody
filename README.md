...
**막히면:** 애플이 서명된 앱만 기본으로 열어 줄 때가 있어요. 앱을 **우클릭 → 열기**로 한 번 열거나, **시스템 설정 → 개인 정보 보호 및 보안**에서 허용을 확인해 보세요. (지금 올라가 있는 DMG는 개발자 서명·공증 없이 빌드돼 있어요.)
...
막히거나 이상하면 [Issues](https://github.com/devuterian/killeverybody/issues)에 남겨 주세요.
